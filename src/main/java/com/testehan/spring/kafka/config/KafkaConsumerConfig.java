package com.testehan.spring.kafka.config;

import com.testehan.spring.kafka.Message;
...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfig(){
        ...
        // don't need this since in method consumerFactory() we defined the deserializers..
